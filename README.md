...
[![GitHub issues](https://img.shields.io/github/issues/maikuh/ghost-on-heroku)](https://github.com/maikuh/ghost-on-heroku/issues)
[![GitHub forks](https://img.shields.io/github/forks/maikuh/ghost-on-heroku)](https://github.com/maikuh/ghost-on-heroku/network)
[![GitHub stars](https://img.shields.io/github/stars/maikuh/ghost-on-heroku)](https://github.com/maikuh/ghost-on-heroku/stargazers)
...
If the above button does not work for you, disable anything that might be blocking Heroku from inferring the referrer (e.g. Brave shield), or try this: https://heroku.com/deploy?template=https://github.com/maikuh/ghost-on-heroku (if you're using a fork, make sure to point the template link to your repo).
...
```bash
git clone https://github.com/maikuh/ghost-on-heroku
cd ghost-on-heroku
...
deployment process provided by _this repository_, then [open an issue here](https://github.com/maikuh/ghost-on-heroku).
